...
SOURCE_DIR="$BASE_DIR/prata/"
DEST_DIR="/Volumes/VRCIB_DS_000123/RECEITA_FEDERAL/GT_03_AVALIACAO_EM_MASSA/05_PRATA/variaveis_municipios/"
...
if [[ "${1:-}" == "--dry-run" ]]; then
  ...
  echo "Sincronizando prata/ para o volume SMB..."
